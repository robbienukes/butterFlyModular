...
var _weaknesses_dict : Dictionary = {}
...
var _next_actions : Array[ActionData] = []
...
func _gather_information() -> Dictionary:
	...
	var actions : Array[ActionData] = _get_available_actions()
	var attack_actions : Array[ActionData] = _get_attack_actions_from(actions)
	var defensive_actions : Array[ActionData] = _get_defensive_actions_from(actions)
...
func _get_available_actions() -> Array[ActionData]:
...
func _get_attack_actions_from(available_actions: Array[ActionData]) -> Array[ActionData]:
...
func _get_defensive_actions_from(available_actions: Array[ActionData]) -> Array[ActionData]:
...
func _get_battler_with_lowest_health(battlers: Array[Battler]) -> Battler:
	if battlers.size() == 0:
		return null
...
func _find_most_damaging_action_from(attack_actions: Array[ActionData]):
...
func _choose() -> Dictionary:
	...
	var battle_info :Dictionary = _gather_information()
