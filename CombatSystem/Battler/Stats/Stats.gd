...
@export var upgradeable_stats = ["max_health", # strength
								"max_energy", # Wisdom
								"physical_attack", # athletics
								"magical_attack", # intelligence
								"physical_defense", #intimidation
								"magical_defense", #arcana
								"speed", # acrobatics
								"hit_chance", # dexterity
								"evasion", # stealth
